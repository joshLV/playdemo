...
public class GoodsTest extends FunctionalTest {
	...
	public void create() {
		...
		goodsParams.put("goods.company_id", "0");
		...
		goodsParams.put("goods.image_path", "/opt/3.jpg");
		goodsParams.put("goods.deleted", "0");
		SimpleDateFormat sdf  =   new  SimpleDateFormat( "yyyy-MM-dd HH:mm:ss" );
		String datestr = sdf.format( new  Date()); 
		goodsParams.put("goods.created_at", datestr);
		goodsParams.put("goods.created_by", "yanjy");
	...
	public void update() {
		...
		goodsParams.put("image_path", "/opt/3.jpg");
		SimpleDateFormat sdf  =   new  SimpleDateFormat( "yyyy-MM-dd HH:mm:ss" );
		String datestr = sdf.format( new  Date()); 
		goodsParams.put("goods.update_at", datestr);
		goodsParams.put("goods.update_by", "yyyy");
