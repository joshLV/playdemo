...
public class PathUtilTest extends TestCase {
    ...
    public void testGetImageUrl() {
        assertEquals("http://imgserver/o/1/1/1/default.png", PathUtil.getImageUrl("http://imgserver","/1/1/1/1.abc",
                null));
        assertEquals("http://imgserver/o/1/1/1/default.png", PathUtil.getImageUrl("imgserver","/1/1/1/1.abc",
                null));
        assertEquals("http://imgserver/o/1/1/1/1.jpg", PathUtil.getImageUrl("imgserver","/1/1/1/1.jpg",
                null));
        assertEquals("http://imgserver/o/1/1/1/1.jpg", PathUtil.getImageUrl("imgserver","/1/1/1/1.jpg",
                ImageSize.ORIGINAL));
        assertEquals("http://imgserver/p/1/1/1/1_small.jpg", PathUtil.getImageUrl("imgserver","/1/1/1/1.jpg",
                ImageSize.SMALL));
    }
