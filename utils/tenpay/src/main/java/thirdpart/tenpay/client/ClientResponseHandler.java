package thirdpart.tenpay.client;
...
import thirdpart.tenpay.util.MD5Util;

import thirdpart.tenpay.util.TenpayUtil;
import org.jdom.JDOMException;
import thirdpart.tenpay.util.XMLUtil;
/**
 * 后台应答类<br/>
 * ========================================================================<br/>
 * api说明：<br/>
...
public class ClientResponseHandler {
	...
	public ClientResponseHandler() {
		...
		this.debugInfo = "";
		this.key = "";
		this.charset = TenpayUtil.getCharacterEncoding();
	}
	...
	*/
	...
	public boolean isTenpaySign() {
		...
		//算出摘要
		String sign = thirdpart.tenpay.util.MD5Util.MD5Encode(sb.toString(), this.charset).toLowerCase();
