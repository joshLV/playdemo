...
public class TuanFeeds extends Controller {
    ...
    public static void tuan800(final long categoryId) {
        //精选商品        
        List<models.sales.Goods> goodsList = CacheHelper.getCache(CacheHelper.getCacheKey(models.sales.Goods.CACHEKEY, "WWW_TUAN_TOPS"), new CacheCallBack<List<models.sales.Goods>>() {
            @Override
