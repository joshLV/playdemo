...
public class OrderChargeTest extends UnitTest{
    ...
    private Order getOrder(){
        Long orderId = (Long)Fixtures.idCache.get("models.order.Order-order_charge");
    ...
    public void setup(){
        ...
        Fixtures.loadModels("fixture/payment_source.yml","fixture/order_charge.yml");
    ...
    public void testCharge(){
        ...
        order.paid();
        account = getAccount();
        assertEquals(order.discountPay, account.amount);
