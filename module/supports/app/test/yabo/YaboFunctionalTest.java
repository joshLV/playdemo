 ...
 */
public abstract class YaboFunctionalTest extends BaseTest {
    ...
    public static Response POST(Request request, Object url, Map<String, String> parameters, Map<String, File> files) {
        ...
        for (String key : files.keySet()) {
            ...
            try {
                ...
                System.out.println("filename=" + key + ", exist=" + files.get(key).exists());
 ...
 */
        ...
        System.out.println("form=" + new String(baos.toByteArray()));
