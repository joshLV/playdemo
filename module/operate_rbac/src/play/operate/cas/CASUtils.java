...
public class CASUtils {
    ...
    public static String getCasLoginUrl(Boolean possibleGateway) {
        ...
        if (isCasMockServer()) {
            casLoginUrl = Router.getFullUrl("operate.cas.MockServer.login");
        }
        else {
    ...
    private static String getCasServiceValidateUrl() {
        ...
        if (isCasMockServer()) {
            casServiceValidateUrl = Router.getFullUrl("operate.cas.MockServer.serviceValidate");
        }
        else {
    ...
    private static String getCasProxyUrl() {
        String casProxyUrl;
        if (isCasMockServer()) {
            casProxyUrl = Router.getFullUrl("operate.cas.MockServer.proxy");
        }
        else {
