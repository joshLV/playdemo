...
public class CASPlugin extends PlayPlugin {
    ...
    public void onRoutesLoaded() {
        if (CASUtils.isCasMockServer()) {
            ...
            Router.addRoute("GET", "/@cas/login", "modules.website.cas.MockServer.login");
            Router.addRoute("POST", "/@cas/authenticate", "modules.website.cas.MockServer.loginAction");
            Router.addRoute("GET", "/@cas/logout", "modules.website.cas.MockServer.logout");
            Router.addRoute("GET", "/@cas/serviceValidate", "modules.website.cas.MockServer.serviceValidate");
            Router.addRoute("GET", "/@cas/proxy", "modules.website.cas.MockServer.proxy");
        }
    }
