...
public class CASUtils {
    ...
    public static String getCasLoginUrl(Boolean possibleGateway) {
        ...
        if (isCasMockServer()) {
            casLoginUrl = Router.getFullUrl("modules.website.cas.MockServer.login");
        }
        else {
    ...
    public static String getCasLogoutUrl() {
        if (isCasMockServer()) {
            return Router.getFullUrl("modules.website.cas.MockServer.logout");
        }
        else {
    ...
    private static String getCasServiceUrl() {
        String casServiceUrl = Router.getFullUrl("modules.website.cas.SecureCAS.authenticate");
    ...
    private static String getCasServiceValidateUrl() {
        ...
        if (isCasMockServer()) {
            casServiceValidateUrl = Router.getFullUrl("modules.website.cas.MockServer.serviceValidate");
        }
        else {
    ...
    private static String getCasProxyCallBackUrl() {
        String casProxyCallBackUrl = Router.getFullUrl("modules.website.cas.SecureCAS.pgtCallBack");
    ...
    private static String getCasProxyUrl() {
        String casProxyUrl;
        if (isCasMockServer()) {
            casProxyUrl = Router.getFullUrl("modules.website.cas.MockServer.proxy");
        }
        else {
