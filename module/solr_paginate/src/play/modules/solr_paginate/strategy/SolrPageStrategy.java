package play.modules.solr_paginate.strategy;
 ...
 * Time: 4:41 PM
 */
public class SolrPageStrategy<T> extends JPARecordLocatorStrategy implements Serializable {
    ...
    public SolrPageStrategy(Class<T> typeToken) {
        super(typeToken);
        this.typeToken = typeToken;
    }

    public SolrPageStrategy(Class<T> typeToken, List keys) {
        this(typeToken);
        this.typeToken = typeToken;
    ...
    public SolrPageStrategy(Class<T> typeToken, String filter, Object... params) {
        this(typeToken);
        this.filter = filter;
        this.params = params;
    }

    public SolrPageStrategy(Class<T> typeToken, String filter, Map<String,
