...
public class CASUtils {
    ...
    private static String getCasServiceUrl() {
        String casServiceUrl = Router.getFullUrl("supplier.cas.SecureCAS.authenticate");
    ...
    private static String getCasProxyCallBackUrl() {
        String casProxyCallBackUrl = Router.getFullUrl("supplier.cas.SecureCAS.pgtCallBack");
