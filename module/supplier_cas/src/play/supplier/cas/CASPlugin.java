...
public class CASPlugin extends PlayPlugin {
    ...
    public void onRoutesLoaded() {
        if (CASUtils.isCasMockServer()) {
            ...
            Router.addRoute("GET", "/@cas/login", "supplier.cas.MockServer.login");
            Router.addRoute("POST", "/@cas/authenticate", "supplier.cas.MockServer.loginAction");
            Router.addRoute("GET", "/@cas/logout", "supplier.cas.MockServer.logout");
