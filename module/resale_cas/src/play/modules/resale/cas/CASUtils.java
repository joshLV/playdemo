 ...
 */
package play.modules.resale.cas;
...
public class CASUtils {
    ...
    public static String getCasLoginUrl(Boolean possibleGateway) {
        ...
        if (isCasMockServer()) {
            casLoginUrl = Router.getFullUrl("modules.resale.cas.MockServer.login");
        }
        else {
    ...
    public static String getCasLogoutUrl() {
        if (isCasMockServer()) {
            return Router.getFullUrl("modules.resale.cas.MockServer.logout");
        }
        else {
    ...
    private static String getCasServiceUrl() {
        String casServiceUrl = Router.getFullUrl("modules.resale.cas.SecureCAS.authenticate");
    ...
    private static String getCasServiceValidateUrl() {
        ...
        if (isCasMockServer()) {
            casServiceValidateUrl = Router.getFullUrl("modules.resale.cas.MockServer.serviceValidate");
        }
        else {
    ...
    private static String getCasProxyCallBackUrl() {
        String casProxyCallBackUrl = Router.getFullUrl("modules.resale.cas.SecureCAS.pgtCallBack");
    ...
    private static String getCasProxyUrl() {
        String casProxyUrl;
        if (isCasMockServer()) {
            casProxyUrl = Router.getFullUrl("modules.resale.cas.MockServer.proxy");
        }
        else {
