...
public class CASPlugin extends PlayPlugin {
    ...
    public void onRoutesLoaded() {
        if (CASUtils.isCasMockServer()) {
            ...
            Router.addRoute("GET", "/@cas/login", "modules.resale.cas.MockServer.login");
            Router.addRoute("POST", "/@cas/authenticate", "modules.resale.cas.MockServer.loginAction");
            Router.addRoute("GET", "/@cas/logout", "modules.resale.cas.MockServer.logout");
            Router.addRoute("GET", "/@cas/serviceValidate", "modules.resale.cas.MockServer.serviceValidate");
            Router.addRoute("GET", "/@cas/proxy", "modules.resale.cas.MockServer.proxy");
        }
    }
