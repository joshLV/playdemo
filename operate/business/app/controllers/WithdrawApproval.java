...
public class WithdrawApproval extends Controller {
    ...
    public static void paymentExcelOut(List<Long> withdrawIds, WithdrawBillCondition condition) {
        ...
        for (WithdrawBill bill : billPage) {
            ...
            String decimal = divide(bill.amount.toString(), false);

            //integer
            int strLength = integer.length();
            for (int i = 0; i < strLength; i++) {
                // 将字符转换成相应的数字大写
                switch (valueUnit[strLength - i + 1]) {
                    case "角":
                        bill.jiao = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.yuan = "￥";
                        }
                        break;
                    case "分":
                        bill.fen = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.jiao = "￥";
                        }
                        break;
                    case "元":
                        bill.yuan = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.ten = "￥";
                        }
                        break;
                    case "拾":
                        bill.ten = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.hundred = "￥";
                        }
                        break;
                    case "佰":
                        bill.hundred = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.thousand = "￥";
                        }
                        break;
                    case "仟":
                        bill.thousand = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.wan = "￥";
                        }
                        break;
                    case "万":
                        bill.wan = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.tenWan = "￥";
                        }
                        break;
                    case "拾万":
                        bill.tenWan = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.hundredWan = "￥";
                        }
                        break;
                    case "佰万":
                        bill.hundredWan = value[integer.charAt(i) - 48];
                        if (i == 0) {
                            bill.thousandWan = "￥";
                        }
                        break;
                    case "仟万":
                        bill.thousandWan = value[integer.charAt(i) - 48];
                        break;
                }
            }
            ...
            for (int i = 0; i < strLength; i++) {
                switch (valueUnit[i]) {
                    case "角":
                        bill.jiao = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.yuan = "￥";
                        }
                        break;
                    case "分":
                        bill.fen = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.jiao = "￥";
                        }
                        break;
                    case "元":
                        bill.yuan = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.ten = "￥";
                        }
                        break;
                    case "拾":
                        bill.ten = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.hundred = "￥";
                        }
                        break;
                    case "佰":
                        bill.hundred = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.thousand = "￥";
                        }
                        break;
                    case "仟":
                        bill.thousand = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.wan = "￥";
                        }
                        break;
                    case "万":
                        bill.wan = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.tenWan = "￥";
                        }
                        break;
                    case "拾万":
                        bill.tenWan = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.hundredWan = "￥";
                        }
                        break;
                    case "佰万":
                        bill.hundredWan = value[decimal.charAt(i) - 48];
                        if (i == 0 && Integer.valueOf(integer).equals(0)) {
                            bill.thousandWan = "￥";
                        }
                        break;
