...
public class SecKillGoodsUnitTest extends UnitTest {
    ...
    public void 取得所有秒杀的商品信息() {
        ...
        FactoryBoy.batchCreate(5, SecKillGoods.class,
                        new SequenceCallback<SecKillGoods>() {
                            @Override
        ...
        JPAExtPaginator<SecKillGoods> secKillGoodsList = SecKillGoods
                        .findByCondition(condition, 0, 10);
