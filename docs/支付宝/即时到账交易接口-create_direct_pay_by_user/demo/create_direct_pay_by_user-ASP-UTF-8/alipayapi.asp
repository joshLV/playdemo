...
'/////////////////////请求参数/////////////////////
        ...
        '必填，不能修改
        '服务器异步通知页面路径
        notify_url = "http://www.xxx.com/create_direct_pay_by_user-CSHARP-UTF-8/notify_url.asp"
        '需http://格式的完整路径，不能加?id=123这类自定义参数
        '页面跳转同步通知页面路径
        return_url = "http://www.xxx.com/create_direct_pay_by_user-CSHARP-UTF-8/return_url.asp"
